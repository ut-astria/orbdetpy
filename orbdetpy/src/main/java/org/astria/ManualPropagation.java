...
public final class ManualPropagation {
	...
	public Array2DRowRealMatrix propagate(double t0, Array2DRowRealMatrix inp, double t1, Array2DRowRealMatrix out,
			boolean enableDMC) {
		propStart = t0;
		propFinal = t1;
